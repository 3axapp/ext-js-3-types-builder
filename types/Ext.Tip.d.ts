declare namespace Ext {
  class Tip extends Ext.Panel {
    ...
    private quickShowInterval: number;
    ...
    private doAutoWidth(adjust: object): void;
    ...
    public showAt(xy: unknown[]): void;

    public showBy(el: unknown, position?: string): void;
